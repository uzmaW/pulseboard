(() => {
  ...
  var require_topbar = __commonJS({
    "vendor/topbar.js"(exports) {
      (function(self2) {
        "use strict";
        if (self2.Topbar) return;
        var Topbar = function() {
          var progress = 0, elements, currentProgress, show, hide, bar, prefix = "progressbar";
          var options = {
            autoRun: true,
            barThickness: 3,
            barColors: {
          ...
          var createBar = function() {
            ...
            progress2.style.cssText = "width:0;height:100%;transition:all .25s ease-out;";
            bar.appendChild(progress2);
